...
-- puntos geográficos de cada estación del metro

-- Lázaro Cárdenas 19.40702104 latitud, -99.14433718 longitud
...
-- calcular distancias entre puntos, en metros (para kilometros se debe dividor en 1000 la consulta /1000)
...
ST_Distance_Sphere(
    ...
    select `location`
    from `locations`
    where  `station_id`="125"
    )
) AS distance;

-- anidadas con un join para buscar con nombres
